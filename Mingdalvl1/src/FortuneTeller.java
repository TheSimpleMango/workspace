...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
    ...
    JOptionPane.showMessageDialog(null, "hi, rub the lamp");
    }
    ...
    public void mousePressed(MouseEvent e) {
    	...
    	int secretLocationX = 215;
    	int secretLocationY = 380;
    	/** If the mouse co-ordinates and secret location are close, we'll let them ask a question. */
    	if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
    		// 8. Get the user to enter a question for the fortune teller
    		JOptionPane.showInputDialog("Enter a yes or no question");
    		// 9. Find a spooky sound and put it in your default package (freesound.org)
    		AudioClip sound = JApplet.newAudioClip(getClass().getResource("ride cymbal.wav"));
    		// 10. Play the sound
    		sound.play();
    		...
    		if (rand == 1) {
				...
				JOptionPane.showMessageDialog(null, "maybeh");
			}
    		else if (rand == 4) {
    			JOptionPane.showMessageDialog(null, "maybeh not");
    		}
    	}
